...
contract('YASC', function ([_, wallet1, wallet2, wallet3, wallet4, wallet5, user1]) {
    ...
    describe('mint', async function () {
        ...
        it('should mint when 1,2,3,4 of 5 voted', async function () {
            ...
            await multiWallet.performAction(yasc.address, action, { from: wallet4 });
        ...
        it('should mint when 1,2,3,5 of 5 voted', async function () {
            ...
            await multiWallet.performAction(yasc.address, action, { from: wallet5 });
            (await yasc.balanceOf.call(user1)).should.be.bignumber.equal(100);
        });
    ...
    describe('transferOwnership', async function () {
        ...
        it('should success twice', async function () {
            ...
            await multiWallet.performAction(yasc.address, action1, { from: wallet1 });
            await multiWallet.performAction(yasc.address, action1, { from: wallet2 });
            await multiWallet.performAction(yasc.address, action1, { from: wallet3 });
            await multiWallet.performAction(yasc.address, action1, { from: wallet4 });
            ...
            await multiWallet2of3.performAction(yasc.address, action2, { from: wallet1 });
            await multiWallet2of3.performAction(yasc.address, action2, { from: wallet2 });
